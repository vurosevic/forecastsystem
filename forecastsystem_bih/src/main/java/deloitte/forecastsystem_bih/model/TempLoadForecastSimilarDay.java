...
@Entity
@Table(name="temp_load_forecast_similar_day")
public class TempLoadForecastSimilarDay implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 1029894418896304383L;
