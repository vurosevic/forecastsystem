...
@Entity
@Table(name="df_load_forecast_arima")
public class LoadForecastArima implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 4996491632930320662L;
