...
public class PreparedDataLoadSum implements Serializable {
	...
	@Column(name="Mesec", nullable=false, unique=true)
	...
	@Column(name="SUM_Load_forecast_entsoe4", nullable=false, unique=true)
	private Double sumLoadForecastEntsoe4;
	...
	@Column(name="SUM_Load_real_data4", nullable=false, unique=true)
	...
	@Column(name="SUM_Load_forecast_entsoe3", nullable=false, unique=true)
	private Double sumLoadForecastEntsoe3;
	...
	@Column(name="SUM_Load_real_data3", nullable=false, unique=true)
	...
	@Column(name="SUM_Load_forecast_entsoe2", nullable=false, unique=true)
	private Double sumLoadForecastEntsoe2;
	...
	@Column(name="SUM_Load_real_data2", nullable=false, unique=true)
	...
	@Column(name="SUM_Load_forecast_entsoe", nullable=false, unique=true)
	private Double sumLoadForecastEntsoe;
	...
	@Column(name="SUM_Load_real_data", nullable=false, unique=true)
	...
	public Double getSumLoadForecastEntsoe4() {
		return sumLoadForecastEntsoe4;
	}



	public void setSumLoadForecastEntsoe4(Double sumLoadForecastEntsoe4) {
		this.sumLoadForecastEntsoe4 = sumLoadForecastEntsoe4;
	}
	...
	public Double getSumLoadForecastEntsoe3() {
		return sumLoadForecastEntsoe3;
	}



	public void setSumLoadForecastEntsoe3(Double sumLoadForecastEntsoe3) {
		this.sumLoadForecastEntsoe3 = sumLoadForecastEntsoe3;
	}
	...
	public Double getSumLoadForecastEntsoe2() {
		return sumLoadForecastEntsoe2;
	}



	public void setSumLoadForecastEntsoe2(Double sumLoadForecastEntsoe2) {
		this.sumLoadForecastEntsoe2 = sumLoadForecastEntsoe2;
	}
	...
	public double[] preparedVector() {
		double[] retval = {
			...
			this.sumLoadForecastEntsoe4, this.minLoadForecastEntsoe4, this.maxLoadForecastEntsoe4,
