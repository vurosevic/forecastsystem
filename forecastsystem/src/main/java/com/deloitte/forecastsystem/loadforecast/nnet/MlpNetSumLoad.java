...
public class MlpNetSumLoad implements MlpNet {
    ...
    public MlpNetSumLoad(int nEpochs, int nSamples, int numInputs, int numOutputs, CountriesEnum country, double momentum, double learningRate, int batchSize,
    		String savePath, String modelNamePart, String earlyStoppingPart) {
    	seed = 123;
    	rng = new Random(seed);
    	data = new DataManipulationSumLoad(country);
