package com.deloitte.forecastsystem.loadforecast.nnet;
...
public class MlpNetAvgLoad implements MlpNet {
    ...
    public MlpNetAvgLoad(int nEpochs, int nSamples, int numInputs, int numOutputs, CountriesEnum country, double momentum, double learningRate, int batchSize,
    		String savePath, String modelNamePart, String earlyStoppingPart) {
    	seed = 123;
    	rng = new Random(seed);
    	data = new DataManipulationAvgLoad(country);
